...
function TTypebotAPI.MarkIsRead(waid, message_id: string): string;
var
  http: TIdHTTP;
...
function TTypebotAPI.SendButton(waid, body, actions, header, footer: string): string;
var
  http: TIdHTTP;
  ssl: TIdSSLIOHandlerSocketOpenSSL;
  postData: TStringStream;
...
function TTypebotAPI.SendContact(waid, phoneNumber, formatted_name, options: string): string;
var
  http: TIdHTTP;
  ssl: TIdSSLIOHandlerSocketOpenSSL;
  postData: TStringStream;
...
function TTypebotAPI.SendFile(waid, body, typeFile, url: string): string;
var
  http: TIdHTTP;
  ssl: TIdSSLIOHandlerSocketOpenSSL;
  postData: TStringStream;
...
function TTypebotAPI.SendListMenu(waid, body, sections, header, footer, Button_Text: string): string;
var
  http: TIdHTTP;
  ssl: TIdSSLIOHandlerSocketOpenSSL;
  postData: TStringStream;
...
function TTypebotAPI.SendLocation(waid, body, Location, header, footer: string): string;
var
  http: TIdHTTP;
  ssl: TIdSSLIOHandlerSocketOpenSSL;
  postData: TStringStream;
...
function TTypebotAPI.SendReaction(waid, message_id, emoji: string): string;
var
  http: TIdHTTP;
  ssl: TIdSSLIOHandlerSocketOpenSSL;
  postData: TStringStream;
...
function TTypebotAPI.SendReplies(waid, message_id, reply_body: string; previewurl: string): string;
var
  http: TIdHTTP;
  ssl: TIdSSLIOHandlerSocketOpenSSL;
  postData: TStringStream;
...
function TTypebotAPI.SendText(waid, body, previewurl: string): string;
var
  http: TIdHTTP;
  ssl: TIdSSLIOHandlerSocketOpenSSL;
  postData: TStringStream;
...
function TTypebotAPI.Send_Template(jsonTemplate: string): string;
var
  http: TIdHTTP;
  ssl: TIdSSLIOHandlerSocketOpenSSL;
  postData: TStringStream;
...
function TTypebotAPI.Send_Template_hello_world(waid: string): string;
var
  http: TIdHTTP;
  ssl: TIdSSLIOHandlerSocketOpenSSL;
  postData: TStringStream;
...
function TTypebotAPI.UploadMedia(FileName: string): string;
var
  http: TIdHTTP;
  ssl: TIdSSLIOHandlerSocketOpenSSL;
  postData: TStringStream;
